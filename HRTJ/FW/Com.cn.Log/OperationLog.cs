...
namespace Com.cn.Log
{
    public sealed class OperationLog
    {
        ...
        /// 憖嶌儘僌柤傪掕媊偡傞丅
        /// </summary>
        private const string OPERATION_LOG_NAME = "Log.Operation";

        /// <summary>
        /// 僨僶僢僋儘僌傪掕媊偡傞丅
        /// </summary>
        private static OperationLog _instance = new OperationLog(OPERATION_LOG_NAME);
        #endregion
        ...
        private OperationLog(string name)
        {
