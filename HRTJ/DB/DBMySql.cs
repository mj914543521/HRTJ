...
namespace Com.cn.DB
{
    public class DBMySql : DBBase
    {
        public DBMySql()
        {
            this.ConnectionString = ConfigManager.GetAppConfig("MySqlConnectionString");
        }
        public override System.Data.DataTable Query(string sql)
        {
        ...
        public override System.Data.DataTable Query(string sql, System.Data.DataTable table)
        {
